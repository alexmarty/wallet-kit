...
public struct Field: Codable {
    ...
    public var attributedValue: Value?
    ...
    public var textAligment: TextAlignment?
    /// Value of the field, for example, 42.
    public var value: Value?
    
    /// Defautl initialiazer
    public init(attributedValue: Value? = nil, changeMessage: String? = nil, dataDetectorTypes: [DataDetectorType]? = nil, key: String, label: String? = nil, textAligment: TextAlignment? = nil, value: Value? = nil) {
